...
#define ERROR_INSTRUCTION_FLAG		"unrecognized flag (condition code not supported by the provided ISA)"
//	Json syntax
...
#define ERROR_JSON_INVALID_BITFIELD_TYPE	"unsupported bitfield type (refer to README)"
