...
// Error strings
//	Libraries
#define ERROR_LIBRARY	"error occured in library, see library's error log above"
//	cJSON
...
#define ERROR_JSON_INVALID_TYPE		"invalid signal type (must be a type listed in the \"types\" array in the Json signals file)"
