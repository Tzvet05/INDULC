...
#define LIB_BLUEPRINT	"blueprint library"
...
#define FUNC_CJSON_PRINT		"cJSON_Print function"
#define FUNC_CJSON_PRINT_UNFORMATTED	"cJSON_PrintUnformatted function"
#define FUNC_CJSON_CREATE_OBJECT	"cJSON_CreateObject function"

// Error strings
//	Libraries
#define ERROR_LIBRARY	COLOR(RED, "library error")
//		Generic
#define ERROR_LIBRARY_LOG	"see library's error log above"
//	Arguments
...
//		Stdout
#define ERROR_WRITE_STDOUT	"failed to write to standard output (stdout)"
//		cJSON
#define ERROR_CJSON_PARSE		"failed to parse content of Json file"
#define ERROR_CJSON_PRINT		"failed to convert cJSON object to formatted printable string"
#define ERROR_CJSON_PRINT_UNFORMATTED	"failed to convert cJSON object to unformatted printable string"
#define ERROR_CJSON_CREATE_OBJECT	"failed to create an instance of a cJSON object"
//	ISA Syntax
#define ERROR_SYNTAX	COLOR(RED, "syntax error")
//		Generic
...
//	Json syntax
#define ERROR_JSON_SYNTAX	COLOR(RED, "Json syntax error")
//		Generic
#define ERROR_JSON_MISSING_ITEM		"Json item missing"
#define ERROR_JSON_TOO_FEW_ITEMS	"Json array contains too few items"
...
//		Signals
#define ERROR_JSON_SIGNAL_TYPE	"invalid signal type (must be a type listed in the \"types\" array in the Json signals file)"

// Warning strings
//	Code syntax
#define WARNING_SYNTAX	COLOR(YELLOW, "syntax warning")
//		Generic
